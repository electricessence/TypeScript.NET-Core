...
<span class="badge-patreon"><a href="http://patreon.com/codeevolution" title="Donate to this project using Patreon"><img src="https://img.shields.io/badge/patreon-donate-yellow.svg" alt="Patreon donate button" /></a></span> <span>Or support by taking this course: https://www.udemy.com/stepping-up-to-typescript-fundamentals/</span>
